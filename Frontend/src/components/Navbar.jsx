...
function Navbar() {
  ...
  return (
    ...
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
      sticky?'sticky-navbar shadow-md bg-black duration-300 transition-all ease-in-out':''
    }`}>
  ...
  <div className="navbar-start">
    ...
    <a href='/' className="text-2xl font-bold cursor-pointer text-white">Manga<span className='text-pink-400'>Mafia</span></a>
  </div>
  ...
  <div className="">
    <a className=" bg-white text-black px-3 py-2 rounded-md hover duration-300 cursor-pointer" onClick={()=>document.getElementById('my_modal_3').showModal()
